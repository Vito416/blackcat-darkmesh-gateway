...
final class TrustKernelConfig
{
    ...
    private const CGI_FIX_PATHINFO_PROBE_ATTESTATION_KEY_LABEL_V1 = 'blackcat.hosting.cgi_fix_pathinfo.probe.canonical_sha256.v1';
    ...
    /** On-chain key (bytes32) for CGI PathInfo probe result commitment (v1). */
    public readonly string $cgiFixPathInfoProbeAttestationKeyV1;
    /** Canonical commitment value (bytes32) representing a "NO EXEC" CGI PathInfo probe result (v1). */
    public readonly string $cgiFixPathInfoProbeNoExecAttestationValueV1;
    ...
    )
    {
        ...
        $this->policyHashV2LessStrict = (new TrustPolicyV2($mode, $maxStaleSec, 'less-strict'))->hashBytes32();
        ...
        $this->policyHashV3LessStrict = (new TrustPolicyV3($mode, $maxStaleSec, 'less-strict', $this->runtimeConfigAttestationKey))->hashBytes32();
        ...
        $this->policyHashV3LessStrictV2 = (new TrustPolicyV3($mode, $maxStaleSec, 'less-strict', $this->runtimeConfigAttestationKeyV2))->hashBytes32();
        ...
        $this->cgiFixPathInfoProbeAttestationKeyV1 = Bytes32::normalizeHex(
            '0x' . hash('sha256', self::CGI_FIX_PATHINFO_PROBE_ATTESTATION_KEY_LABEL_V1)
        );

        $this->cgiFixPathInfoProbeNoExecAttestationValueV1 = Bytes32::normalizeHex(CanonicalJson::sha256Bytes32([
            'schema_version' => 1,
        ...
        $this->policyHashV4LessStrict = (new TrustPolicyV4(
            $mode,
            $maxStaleSec,
            'less-strict',
            $this->runtimeConfigAttestationKey,
        ...
        $this->policyHashV5LessStrict = (new TrustPolicyV5(
            $mode,
            $maxStaleSec,
            'less-strict',
            $this->runtimeConfigAttestationKey,
        ...
        $this->policyHashV4LessStrictV2 = (new TrustPolicyV4(
            $mode,
            $maxStaleSec,
            'less-strict',
            $this->runtimeConfigAttestationKeyV2,
        ...
        $this->policyHashV5LessStrictV2 = (new TrustPolicyV5(
            $mode,
            $maxStaleSec,
            'less-strict',
            $this->runtimeConfigAttestationKeyV2,
