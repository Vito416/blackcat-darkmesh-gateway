...
final class TrustPolicyV2
{
     ...
     * @param 'strict'|'less-strict'|'warn' $enforcement
     */
    public function __construct(
        ...
        if ($enforcement === '' || !in_array($enforcement, ['strict', 'less-strict', 'warn'], true)) {
            throw new \InvalidArgumentException('Invalid trust policy enforcement (expected strict|less-strict|warn).');
        }
    }
