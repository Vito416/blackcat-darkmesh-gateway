...
function validSummaryMarkdown() {
  return [
    ...
    '## Rollback reference',
    '',
    '- **Rollback reference:** `kernel-migration/rollback-plan-2026-04-11.md`',
    '- **Rollback owner:** `@operator-01`',
    '- **Rollback command / procedure:** `bash scripts/rollback.sh --plan kernel-migration/rollback-plan-2026-04-11.md`',
