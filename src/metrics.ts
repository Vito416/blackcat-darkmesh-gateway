...
const help: Record<string, string> = {
  ...
  gateway_template_secret_guard_blocked_total: 'Template API calls blocked by secret guard',
  gateway_template_signer_ref_mismatch_total: 'Template API calls blocked by signer signatureRef mismatch',
  gateway_template_signer_ref_map_invalid_total: 'Template API calls blocked by invalid signer signatureRef map',
