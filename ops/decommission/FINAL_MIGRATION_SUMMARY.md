...
| --- | --- | --- | --- |
| Final release drill | `2026-04-12T16:35:12Z` | `ops/decommission/release-drill-manifest.json` | Pending generation in next drill run; runbook already updated. |
| Release evidence ledger | `2026-04-12T16:35:12Z` | `ops/decommission/release-evidence-ledger.json` | Pending generation; build script is available. |
...
| Staging / production-like validation | `2026-04-12T16:35:12Z` | `ops/decommission/DECOMMISSION_CHECKLIST.md` | Ready to execute after AO/manual blockers clear. |
| Manual operator proof | `2026-04-12T16:35:12Z` | `ops/decommission/SIGNOFF_RECORD.md` | Reserved for final stakeholder signoff package. |
